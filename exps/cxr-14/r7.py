    ...
    'model': {  
        ...
        'context_encoder': {
            ...
            'spec':{
                ...
                'ATTN_LAYER': [['Attention'], ['Attention', 'Attention'], ['Attention']*10, ['Attention_v5']],
                'PATCH_SIZE': [7, 3, 3, 3],
                'PATCH_STRIDE': [4, 2, 2, 2],
                'PATCH_PADDING': [2, 1, 1, 1],
                'DIM_EMBED': [64, 192, 384, 384],
                'NUM_HEADS': [1, 3, 6, 6],
                'DEPTH': [1, 2, 10, 1],
                'MLP_RATIO': [4.0, 4.0, 4.0, 4.0],
                'ATTN_DROP_RATE': [0.0, 0.0, 0.0, 0.0],
                'DROP_RATE': [0.0, 0.0, 0.0, 0.0],
                'DROP_PATH_RATE': [0.0, 0.0, 0.1, 0.01],
                'QKV_BIAS': [True, True, True, True],
                'CLS_TOKEN': [False, False, True, False],
